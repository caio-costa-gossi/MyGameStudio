...
public:
	static Err RunGame(enums::GameDebugType debugType = enums::no_debug_from_child, enums::ConsoleMessageType minLevel = enums::ConsoleMessageType::info, uint32_t disableChannelMask = 0);
	static Err QuitGame();
